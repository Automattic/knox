...
exports.authorization = function(options){
  return options.identifier + ' ' + options.key + ':' + exports.sign(options);
};
...
exports.stringToSign = function(options){
  var headers = options.storageHeaders || '';
  if (headers) headers += '\n';
  return [
      options.verb
    , options.md5
 ...
 *
 *  - ignore non-amazon/non-google headers
 *  - lowercase fields
