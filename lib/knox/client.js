 ...
 * Assumed that Content-Length header is set properly.
 * @param {Stream} stream
 * @param {String} filename
 * @param {Object} headers
 * @param {Function} fn
...
Client.prototype.putNonFileSystemStream = function (stream, filename, headers, fn) {
  var req = this.put(filename, utils.merge({'Content-Type': 'application/octet-stream'}, headers));
